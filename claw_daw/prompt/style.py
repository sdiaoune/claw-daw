...
STYLE_PRESETS: dict[StyleName, StylePreset] = {
    ...
    "house": StylePreset(style="house", bpm_default=124, swing_percent=0, drum_density=0.85, mastering_preset="clean"),
    "techno": StylePreset(style="techno", bpm_default=132, swing_percent=0, drum_density=0.90, mastering_preset="clean"),
    "trap": StylePreset(style="trap", bpm_default=140, swing_percent=0, drum_density=0.82, mastering_preset="clean"),
    "boom_bap": StylePreset(style="boom_bap", bpm_default=90, swing_percent=18, drum_density=0.70, mastering_preset="clean"),
